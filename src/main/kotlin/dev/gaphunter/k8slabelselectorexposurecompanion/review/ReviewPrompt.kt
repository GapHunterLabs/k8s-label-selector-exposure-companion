package dev.gaphunter.k8slabelselectorexposurecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.k8slabelselectorexposurecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.k8slabelselectorexposurecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "K8s Label-Selector Exposure Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34064-k8s-label-selector-exposure-companion/reviews"
